...
public class TestHandlerJsonFieldSchema {
    ...
    private AssemblyAllOfClass assemblyAllOfClass;

    private AssemblyAnyOfClass assemblyAnyOfClass;

    private AssemblyOneOfClass assemblyOneOfClass;

    /**
     * class 的优先级 高于field 上面的    @Schema的优先级
     */
    @Schema(allOf = {AssemblyOne.class, AssemblyTwo.class, AssemblyThree.class})
    private AssemblyAllOfField assemblyAllOfField;

    @Schema(oneOf = {AssemblyOne.class})
    private AssemblyOneOfField assemblyOneOfField;

    @Schema(anyOf = AssemblyOne.class)
    private AssemblyAnyOfField assemblyAnyOfField;
